...
activities = {
    ...
    "Drama Club": {
        ...
        "max_participants": 25,
        "participants": ["alex@mergington.edu", "isabella@mergington.edu", "mason@mergington.edu"]
    },
    "Debate Team": {
    ...
    "Math Olympiad": {
        "description": "Compete in advanced mathematics competitions and problem-solving",
...
@app.get("/activities")
def get_activities():
    # Calculate availability for each activity
    result = {}
    for name, activity in activities.items():
        ...
        result[name] = {
            ...
            "availability": f"{spots_left} spots left",
